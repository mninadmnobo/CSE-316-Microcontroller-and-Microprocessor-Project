...
An Arduino-based smart gardening automation system that monitors plant conditions and controls irrigation, spraying, fertilizing, and shading in semi-automatic and automatic modes.

This project is designed as a featured embedded systems showcase for microcontroller coursework, combining:

- Environmental sensing (temperature, humidity, soil moisture, rain)
- Actuator automation (watering, pesticide pump, fertilizer pump, spray motor)
- Mobile control and telemetry over Bluetooth
- Real-time status feedback on a 16x2 I2C LCD
- Heat and weather protection using a stepper-driven shade
